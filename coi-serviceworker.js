...
if (typeof window === 'undefined') {
    ...
    (() => {
        ...
        // Поведение SW можно подкрутить через window.coi до загрузки этого скрипта.
        const coi = {
        ...
        // Уже cross-origin isolated (COOP/COEP пришли с сервера или SW уже работает) —
        // ничего не делаем. Если crossOriginIsolated не определён (старый браузер) — тоже выходим.
